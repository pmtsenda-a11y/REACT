...
📖 Biblioteca, 💊 Farmacia, 🏋️ Gimnasio, 🏫 Escuela, 🏬 Tienda de mascotas, 🍽️ Restaurante, 🏦 Banco, 🚕 Taxis, 🏥 Hospital, 🎥 Cine, 🏞️ Hotel, ✈️ Viajes, 🏎️ Concesionario, 👗 Ropa, 🛠️ Taller, y más...
...
- 💬 Discussions: [GitHub Discussions](https://github.com/ergrato-dev/bc-react/discussions)
- 🐛 Issues: [GitHub Issues](https://github.com/ergrato-dev/bc-react/issues)
...
- [React Docs](https://react.dev/) — Por la mejor documentación de React
- [TypeScript Handbook](https://www.typescriptlang.org/docs/) — Documentación oficial
- [MDN Web Docs](https://developer.mozilla.org/) — Referencia web estándar
...
<p align="center">
  <strong>🎓 Bootcamp React + TypeScript</strong><br>
  <em>De JavaScript intermedio a desarrollador React Mid-Level en 5 meses</em>
</p>
